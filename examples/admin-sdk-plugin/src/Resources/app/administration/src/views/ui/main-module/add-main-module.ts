...
import { notification, context, data, window } from '@heyframe-ag/meteor-admin-sdk';
import { SwButton, SwTextField, SwTextarea } from '@heyframe-ag/meteor-component-library';
...
export default defineComponent({
    ...
    template: `
        <div style="padding: 20px;">
            ...
            <div>
                <h3>Context - Get current HeyFrame version</h3>
                <sw-button @click="getHeyFrameVersion">Get current HeyFrame version</sw-button>

                <p>
                    HeyFrame version: {{ heyframeVersion }}
                </p>
            </div>
            ...
            routeInformation:  `
{
    ...
    methods: {
        ...
        // context / get current HeyFrame version
        async getHeyFrameVersion() {
            this.heyframeVersion = await context.getHeyFrameVersion();
        },
