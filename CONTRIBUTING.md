...
HeyFrame is available under [MIT license](./LICENSE.md).
...
Please take a look at the [existing issues](https://github.com/heyframe/meteor/issues)
...
Search trough the [list of existing feature requests](https://github.com/heyframe/meteor/issues),
...
you can [request a feature](https://github.com/heyframe/meteor/issues/new).
...
3. Link package in the HeyFrame Administration folder with `yalc link <package-name@package-version>`
...
2. Go to the [actions tab](https://github.com/heyframe/meteor/actions)
3. Click on [Visual Tests](https://github.com/heyframe/meteor/actions) in the left sidebar
