...
You need to have an working [app](https://developer.heyframe.com/docs/guides/plugins/apps/app-base-guide) or [plugin](https://developer.heyframe.com/docs/guides/plugins/plugins/plugin-base-guide) installed on your HeyFrame 6 instance.
...
For development purposes you can use [App server sdk](https://github.com/heyframe/app-sdk-js).

Once you got the registration/ handshake working you need to add the `<base-app-url>` field to the `<admin>` section of the [manifest](https://developer.heyframe.com/docs/guides/plugins/apps/app-base-guide#manifest-file) file. This field should contain the public URL of your app. Let's assume your app HTML page is served under `http://localhost/my-example-app.html`:

```xml
<?xml version="1.0" encoding="UTF-8"?>
<manifest xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="https://raw.githubusercontent.com/heyframe/platform/trunk/src/Core/Framework/App/Manifest/Schema/manifest-1.0.xsd">
    <meta>
...
### Plugin:
**Notice:** Plugins will work on self-hosted instances only. You won't be able to use a HeyFrame 6 cloud instance with plugins.

#### For HeyFrame 6.7 and higher:
...
with `npm i --save @heyframe-ag/meteor-admin-sdk`.
...
import { dispatch as dispatchNotification } from '@heyframe-ag/meteor-admin-sdk/es/notification'
...
### Using auto-generated types from HeyFrame
This is the easiest solution. Just install the correct type definition for the matching heyframe version:

`npm install @shopware-ag/entity-schema-types@5.0.0`

The version number should match the HeyFrame version number without the `6.` in the beginning. Examples:  

`HeyFrame 6.5.0.0` → `@shopware-ag/entity-schema-types@5.0.0`
`HeyFrame 6.5.1.2` → `@shopware-ag/entity-schema-types@5.1.2`
`HeyFrame 6.6.3.1` → `@shopware-ag/entity-schema-types@6.3.1`
