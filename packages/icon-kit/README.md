[![npm version](https://badge.fury.io/js/@heyframe-ag%2Fmeteor-icon-kit.svg)](https://badge.fury.io/js/@heyframe-ag%2Fmeteor-icon-kit)

# meteor-icon-kit

> An icon library and toolkit that follows a minimal, yet highly expressive style perfectly aligned with HeyFrame's product language
...
```sh
$ npm install @heyframe-ag/meteor-icon-kit
```

Or if you prefer using Yarn:

```sh
$ yarn add @heyframe-ag/meteor-icon-kit
```
...
```scss
@import "@heyframe-ag/meteor-icon-kit/icons/meteor-icon-kit.scss";
```
...
```js
import wallet from "@heyframe-ag/meteor-icon-kit/icons/regular/wallet.svg";
```
...
<script setup>
import ActivityIcon from "@heyframe-ag/meteor-icon-kit/icons/regular/activity.svg";
</script>
```
...
Meteor Icon Kit is available as a [Figma library](https://www.figma.com/community/file/1032564947404478461/Meteor-Icon-Kit-%E2%80%93-HeyFrame) through the Figma Community. To use the icons, log in to your Figma account and duplicate the file to your drafts.
