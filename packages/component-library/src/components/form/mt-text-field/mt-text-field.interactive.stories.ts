...
export const TestInputValue: MtTextFieldStory = {
  ...
  play: async ({ canvasElement, args }) => {
    ...
    await userEvent.type(canvas.getByRole("textbox"), "HeyFrame");
    await userEvent.click(canvas.getByText("hidden"));

    expect((canvas.getByRole("textbox") as HTMLInputElement).value).toBe("HeyFrame");

    expect(args.change).toHaveBeenCalledWith("HeyFrame");
  },
};
...
export const VisualTestCharacterCountExceeding: MtTextFieldStory = {
  ...
  play: async ({ canvasElement, args }) => {
    ...
    await userEvent.type(
      ...
      "HeyFrame is a trendsetting ecommerce platform to power your online business.",
    );
    await userEvent.click(canvas.getByText("hidden"));
    ...
    expect(args.updateModelValue).toHaveBeenCalledWith(
      "HeyFrame is a trendsetting ecommerce platform to power your ",
    );
