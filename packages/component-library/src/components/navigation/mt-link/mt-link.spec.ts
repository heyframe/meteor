...
describe("mt-link", () => {
  it("renders a link", async () => {
    ...
    render(MtLink, {
      props: {
        as: "a",
        to: "https://www.heyframe.com",
      },
    });

    // ASSERT
    expect(screen.getByRole("link")).toBeVisible();
    expect(screen.getByRole("link")).toHaveAttribute("href", "https://www.heyframe.com");
  ...
  it("renders the correct slot content", async () => {
    ...
    // ASSERT
    expect(screen.getByRole("link")).toHaveTextContent("HeyFrame");
  });
  ...
  it("does not redirect when clicking on a disabled link", async () => {
    ...
    // ASSERT
    expect(screen.getByRole("link")).not.toHaveAttribute("href", "https://www.heyframe.com");
  });
