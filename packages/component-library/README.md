...
The meteor component library is a Vue component library developed by HeyFrame. It is based on the [Meteor Design System](https://heyframe.design/).

- Perfect suitable for HeyFrame Apps
- Matches the HeyFrame administration look and feel
...
```cli
npm i @heyframe-ag/meteor-component-library
```
...
```html
<script>
  import { MtButton } from "@heyframe-ag/meteor-component-library";
